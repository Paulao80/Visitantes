...
{
    public class EntradaGuaritaReport : IEntradaGuaritaReport
    {
        private readonly IEntradasSaidasRepository _EntradasSaidasRepository;
        private MemoryStream _Stream;
        private Document _Doc;        

        public EntradaGuaritaReport(IEntradasSaidasRepository entradasSaidasRepository)
        {
        ...
        public void Gerar(DateTime dateIni, DateTime dateEnd)
        {
            ...
            foreach(var item in _EntradasSaidasRepository.GetEntradas(dateIni, dateEnd))
            {
