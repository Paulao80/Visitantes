...
{
    public class SaidaTransporteReport : ISaidaTransporteReport
    {
        private readonly ISaidasEntradasRepository _SaidasEntradasRepository;
        private MemoryStream _Stream;
        private Document _Doc;

        public SaidaTransporteReport(ISaidasEntradasRepository saidasEntradasRepository)
        {
        ...
        public void Gerar(DateTime dateIni, DateTime dateEnd)
        {
            ...
            Paragraph titulo = new Paragraph("SAIDAS", titleFont);
            ...
            foreach(var item in _SaidasEntradasRepository.GetSaidas(dateIni, dateEnd))
            {
